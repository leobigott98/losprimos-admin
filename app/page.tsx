      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20">
          <p className={`${lusitana.className} antialiased text-xl text-gray-800 md:text-3xl md:leading-normal`}>
            <strong>Bienvenido a Los Primos</strong><br/> A través de este sistema administrador podrás gestionar las órdenes de El Arepazo y Smash Rico.
          </p>
          <Link
            href="/auth/sign-in"
        ...
        <div className="flex items-center justify-center p-6 md:w-full md:px-28 md:py-12">
          ...
          <Logo href='/auth/sign-in' className='object-cover' />
          {/* <Image
